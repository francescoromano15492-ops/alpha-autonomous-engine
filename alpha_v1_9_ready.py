...
APP_VERSION = "Alpha v1.9 — Low-Turnover Execution Edge + Spot/Futures Cost Stress"
...
PREREGISTRATION = {
    "version": "v1.9-low-turnover-execution-edge-paper",
    "mode": "paper_only",
...
HTML = r"""
<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><title>Alpha v1.9</title>
<style>
...
<h1>Alpha v1.9 — Low-Turnover Execution Edge + Spot/Futures Cost Stress</h1>
<div class="m">Live engine unchanged · 365d low-turnover 4h/12h research · Kraken spot/futures cost stress · same-entry pairing · 5-fold walk-forward · paper only.</div>
...
async function go(){
 ...
 let l=s.last_scan||{},f=s.performance||{},r=s.research||{},a=s.lab||{},e=s.edge||{},q=s.rs_specialist||{},z=s.architecture||{},v=s.execution_edge||{};
