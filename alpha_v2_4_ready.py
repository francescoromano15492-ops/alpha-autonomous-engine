...
APP_VERSION = "Alpha v2.4 — Derivatives Intelligence Lab"
...
async def startup():
    global ENGINE_TASK, RESEARCH_TASK, SHADOW_TASK, DERIVATIVES_TASK
...
HTML = r"""
<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><title>Alpha v2.4</title>
<style>
...
<h1>Alpha v2.4 — Derivatives Intelligence Lab</h1>
<div class="m">Live engine unchanged · persistent forward-only derivatives and microstructure data · v2.0 shadow epoch preserved · paper only.</div>
...
async function go(){
 ...
 let l=s.last_scan||{},f=s.performance||{},r=s.research||{},a=s.lab||{},e=s.edge||{},q=s.rs_specialist||{},z=s.architecture||{},v=s.execution_edge||{},u=s.parallel_lab||{},y=s.regime_lab||{},d=s.diversified_lab||{},di=s.derivatives_intelligence||{},h=s.shadow_forward||{};
