...
APP_VERSION = "Alpha v2.5 — Causal Microstructure Lab"
...
HTML = r"""
<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><title>Alpha v2.5</title>
<style>
...
<h1>Alpha v2.5 — Causal Microstructure Lab</h1>
<div class="m">Live engine unchanged · causal 1h/4h forward tests on persistent microstructure data · v2.0 shadow epoch preserved · paper only.</div>
...
async function go(){
 ...
 let l=s.last_scan||{},f=s.performance||{},r=s.research||{},a=s.lab||{},e=s.edge||{},q=s.rs_specialist||{},z=s.architecture||{},v=s.execution_edge||{},u=s.parallel_lab||{},y=s.regime_lab||{},d=s.diversified_lab||{},di=s.derivatives_intelligence||{},mi=s.microstructure_lab||{},h=s.shadow_forward||{};
