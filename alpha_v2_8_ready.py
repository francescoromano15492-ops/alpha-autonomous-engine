...
APP_VERSION = "Alpha v2.8 — Extreme Funding Shadow"
...
def extreme_shadow_summary():
    ...
    return {"state":"running","started_at_epoch":epoch,"started_at":datetime.fromtimestamp(epoch,timezone.utc).isoformat(),
            ...
            "note":"Forward-only frozen v2.8 pair. Isolated virtual ledger; no paper-account or live orders."}
...
def extreme_shadow_step():
    ...
    if aligned and latest_bucket>=int(epoch) and not DBX.extreme_shadow_pair_exists(latest_bucket):
...
HTML = r"""
<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><title>Alpha v2.8</title>
<style>
...
<h1>Alpha v2.8 — Extreme Funding Shadow</h1>
<div class="m">Frozen 4h extreme-funding pair · forward-only isolated ledger · live paper rules unchanged.</div>
