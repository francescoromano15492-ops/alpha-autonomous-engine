...
APP_VERSION = "Alpha v1.5 — Research Lab + Cost-Stress Walk-Forward Paper Engine"
...
PREREGISTRATION = {
    "version": "v1.5-research-lab-cost-stress-walk-forward-paper",
    "mode": "paper_only",
...
HTML = r"""
<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><title>Alpha v1.5</title>
<style>
...
<h1>Alpha v1.5 — Research Lab + Cost-Stress Walk-Forward Paper Engine</h1>
<div class="m">Live engine unchanged · parameter lab report-only · 3 cost stress scenarios · expanding walk-forward · paper only.</div>
<p class="warn"><b>Research/paper only.</b> The lab does not alter live parameters, increase risk, or route real orders. Full-sample winners can be overfit; walk-forward evidence is the main gate.</p>
...
async function go(){
 ...
 let l=s.last_scan||{},f=s.performance||{},r=s.research||{},a=s.lab||{};
