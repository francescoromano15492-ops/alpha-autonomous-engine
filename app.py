...
APP_VERSION = "Alpha v2.2 — Regime-Aware Breakout Lab"
...
PREREGISTRATION = {
    "version": "v2.2-regime-aware-breakout-lab-paper",
    "mode": "paper_only",
...
HTML = r"""
<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><title>Alpha v2.2</title>
<style>
...
<h1>Alpha v2.2 — Regime-Aware Breakout Lab</h1>
...
async function go(){
 ...
 let l=s.last_scan||{},f=s.performance||{},r=s.research||{},a=s.lab||{},e=s.edge||{},q=s.rs_specialist||{},z=s.architecture||{},v=s.execution_edge||{},u=s.parallel_lab||{},y=s.regime_lab||{},h=s.shadow_forward||{};
