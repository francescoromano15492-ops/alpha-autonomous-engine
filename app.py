...
APP_VERSION = "Alpha v2.7 — Cost-Aware Extreme Funding Lab"
...
HTML = r"""
<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><title>Alpha v2.7</title>
<style>
...
<h1>Alpha v2.7 — Cost-Aware Extreme Funding Lab</h1>
<div class="m">Failed v2.6 entries retired · low-frequency extreme-pair funding tests · live paper rules unchanged.</div>
...
async function go(){
 ...
 let l=s.last_scan||{},f=s.performance||{},r=s.research||{},a=s.lab||{},e=s.edge||{},q=s.rs_specialist||{},z=s.architecture||{},v=s.execution_edge||{},u=s.parallel_lab||{},y=s.regime_lab||{},d=s.diversified_lab||{},di=s.derivatives_intelligence||{},mi=s.microstructure_lab||{},ms=s.micro_shadow||{},xf=s.extreme_funding_lab||{},h=s.shadow_forward||{};
