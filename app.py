...
APP_VERSION = "Alpha v2.0 — Shadow Forward Lab"
...
PREREGISTRATION = {
    "version": "v2.0-shadow-forward-lab-paper",
    "mode": "paper_only",
...
HTML = r"""
<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><title>Alpha v2.0</title>
<style>
...
<h1>Alpha v2.0 — Shadow Forward Lab</h1>
<div class="m">Live engine unchanged · v1.9 research retained · forward-only shadow tracking of two frozen hypotheses · persistent ledger · paper only.</div>
...
async function go(){
 ...
 let l=s.last_scan||{},f=s.performance||{},r=s.research||{},a=s.lab||{},e=s.edge||{},q=s.rs_specialist||{},z=s.architecture||{},v=s.execution_edge||{},h=s.shadow_forward||{};
