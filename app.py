...
APP_VERSION = "Alpha v1.8.1 — Architecture Sanity + Kraken Cost Model"
...
PREREGISTRATION = {
    "version": "v1.8.1-architecture-sanity-kraken-cost-model-paper",
    "mode": "paper_only",
...
HTML = r"""
<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><title>Alpha v1.8.1</title>
<style>
...
<h1>Alpha v1.8.1 — Architecture Sanity + Kraken Cost Model</h1>
<div class="m">Live engine unchanged · architecture sanity filters · Kraken reference fee overlays · same-entry cost pairing · 5-fold outer walk-forward · paper only.</div>
