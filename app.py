...
APP_VERSION = "Alpha v2.9.1 — Selective Funding Shadow"
...
HTML = r"""
<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><title>Alpha v2.9.1</title>
<style>
...
<h1>Alpha v2.9.1 — Selective Funding Shadow</h1>
...
<h2>v2.9.1 Selective Funding Shadow — forward-only</h2><div id="selective"></div><h3>Entry decisions, including skipped windows</h3><div id="selectivedecisions"></div><h3>Open virtual pair</h3><div id="selectivepositions"></div><h3>Recent virtual pairs</h3><div id="selectivetrades"></div>
