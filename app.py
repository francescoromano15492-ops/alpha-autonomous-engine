...
APP_VERSION = "Alpha v2.6 — Microstructure Shadow Execution"
...
def micro_shadow_summary():
    ...
    return {
        "state":"running", "started_at_epoch":epoch,
        ...
        "evidence_gate":"MICRO_SHADOW_EVIDENCE_CANDIDATE" if overall["trades"]>=30
            and (overall.get("avg_net_bps") or -999)>0 and (overall.get("profit_factor") or 0)>1.10
            else "MICRO_SHADOW_COLLECTING",
        "note":"Forward-only virtual execution of frozen v2.5 funding hypotheses. It cannot affect the paper account or place real orders.",
    }
...
HTML = r"""
<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><title>Alpha v2.6</title>
<style>
...
<h1>Alpha v2.6 — Microstructure Shadow Execution</h1>
<div class="m">Live engine unchanged · frozen funding signals now execute in an isolated forward-only virtual ledger · paper only.</div>
...
async function go(){
 ...
 let l=s.last_scan||{},f=s.performance||{},r=s.research||{},a=s.lab||{},e=s.edge||{},q=s.rs_specialist||{},z=s.architecture||{},v=s.execution_edge||{},u=s.parallel_lab||{},y=s.regime_lab||{},d=s.diversified_lab||{},di=s.derivatives_intelligence||{},mi=s.microstructure_lab||{},ms=s.micro_shadow||{},h=s.shadow_forward||{};
